...
/*
 *  Paths to games data, as generated by games-update service
 */

const gamesDataPath = path.resolve(paths.data, 'games.json')
const gamesTestDataPath = path.resolve(paths.data, 'games-test.json')
